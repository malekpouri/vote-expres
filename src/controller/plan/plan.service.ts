import { ForbiddenError, NotfoundError, httpError } from "../../errors/http-error";
...
export class PlanService {
  ...
  getPlanByID(id: number) {
    const plan = this.planRepository.getById(id);
...
createProgram = (
    ...
    const plan = this.planRepository.getById(dto.planId);
